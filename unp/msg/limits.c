...
* Version: V1.0                                                      *
* Time: Wed 12 Nov 2014 10:17:00 PM CST
* Description:                                                       *
*********************************************************************/
#include "all.h"
...
int main(int argc, char **argv)
{
	...
	//first try and determine maxinum amount of data we can send
	...
	{
		mesg = Msgget(IPC_PRIVARTE, SVMSG_MODE | IPC_CREAT);
		...
		printf("%d %d-byte message were placed onto queue,", j, i);
	...
	{
		if ((qid[i] = msgget(IPC_CREATE, SVMSG_MODE | IPC_CREAT)) == -1)
		{
